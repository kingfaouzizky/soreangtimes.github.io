...
if ( ! class_exists( 'CSCO_Theme_Activation' ) ) {
	...
	function csco_get_license_data( $param ) {
		$data = array('status'=>'1', 'demos'=>'csco_theme_demos', 'ocdi'=>array('parent_slug'=>'themes.php', 'page_title'=>'Demo Content', 'menu_title'=>'Demo Content', 'capability'=>'import', 'menu_slug'=>'demo'), 'license_history'=>array(array('status'=>'active', 'purchase_count'=>'1', 'domain'=>get_site_url(), 'email'=>'test@test.com')), 'item_id'=>'23389898', 'sold_at'=>date('Y-m-d',strtotime('-1 year')),'supported_until'=>date('Y-m-d',strtotime('+1 year')), 'purchase_count'=>'999', 'message'=>'<div class="notice notice-success"><p>Licence key activated. All theme features are now unlocked.</p></div>');
