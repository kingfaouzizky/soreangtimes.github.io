...
$scheme = csco_color_scheme(
	get_theme_mod( 'color_large_header_bg', '#ffffff' ),
	get_theme_mod( 'color_large_header_bg_dark', '#1c1c1c' )
);
?>

<div class="navbar navbar-topbar <?php echo esc_attr( $class ); ?>" <?php echo wp_kses( $scheme, 'post' ); ?>>
...
<nav class="navbar navbar-primary navbar-bottombar <?php echo esc_attr( $class ); ?>" <?php echo wp_kses( $scheme, 'post' ); ?>>
